<div class="container-fluid py-5 px-0 bg-custom-book">
    <div class="container">
        <div class="mb-4">
            ...
            <h1 class="mt-2 custom-title-book">Ajouter les informations</h1>
        </div>
        <div class="row justify-content-center bg-white p-4 rounded shadow-sm">
            <div class="row gap-5">
                ...
                <div class="col-auto bloc-photo-custom">
                    ...
                    <img src="/images/livres.jpeg" alt="Image du livre"
                ...
                <div class="col-auto" style="width: 488px; margin-left: 30px;">
                    <form method="POST" action="index.php?page=addBookSubmit">
                        <input type="hidden" name="id" value="<?= $book->getId() ?>">

                        <div class="mb-3">
                            <label for="title" class="form-label">Titre</label>
                            <input type="text" class="form-control input-title" id="title" name="title" value="">
                        </div>

                        <div class="mb-3">
                            <label for="author" class="form-label">Auteur</label>
                            <input type="text" class="form-control input-author" id="author" name="author" value="">
                        </div>

                        <div class="mb-3">
                            <label for="description" class="form-label">Commentaire</label>
                            <textarea class="form-control textarea-description" id="description" name="description"></textarea>
                        </div>
