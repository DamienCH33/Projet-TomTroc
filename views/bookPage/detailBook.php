  ...
  <div class="container-fluid h-100 mt-3 p-0">
    <div class="container">
      <div class="row h-100 p-0 align-items-stretch">
        <div class="mb-4" style="white-space: nowrap;">
          <a href="index.php?page=BookExchange" class="text-decoration-none text-custom me-2">Nos livres</a>
          <span class="text-muted me-2">&gt;</span>
          <a href="index.php?page=DetailBook&id=<?= htmlspecialchars($book->getId()) ?>" class="text-decoration-none text-custom">
